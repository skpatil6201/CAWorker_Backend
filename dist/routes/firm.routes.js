...
const firm_validator_1 = require("../validators/firm.validator");
const validation_middleware_1 = require("../middleware/validation.middleware");
const auth_middleware_1 = require("../middleware/auth.middleware");
const router = (0, express_1.Router)();
// Public routes
router.post("/firms/register", firm_validator_1.firmRegistrationValidator, validation_middleware_1.handleValidationErrors, firm_controller_1.registerFirm);
router.post("/firms/login", firm_validator_1.firmLoginValidator, validation_middleware_1.handleValidationErrors, firm_controller_1.loginFirm);
